    ...
    scenes: {
      ...
      items: {
        ...
        properties: {
          ...
          action: { type: 'string', enum: ['idle', 'wave', 'hug', 'give', 'jump', 'dance', 'cry', 'sulk', 'point', 'clap', 'nod', 'shake', 'walkin', 'hit', 'look'] },
        },
